(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".costumers__slider")) new core(".costumers__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            spaceBetween: 30,
            ...
            loop: true,
            navigation: {
                prevEl: ".costumers__slider .swiper-button-prev",
                nextEl: ".costumers__slider .swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.1,
    ...
    function documentActions() {
        ...
        const cartValue = document.querySelector(".actions-header__icon span");
        const speedAnimation = 1e3;
        document.addEventListener("click", (function(e) {
            const targetElement = e.target;
            if (targetElement.closest(".slide-products__button")) {
